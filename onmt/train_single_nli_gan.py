...
from onmt.trainer_nli_gan import build_trainer
from onmt.models import build_model_saver
from onmt.utils.logging import init_logger, logger
from onmt.utils.parse import ArgumentParser
from onmt.critic_builder import build_model as build_critic_model
...
def main(opt, device_id, batch_queue=None, semaphore=None):
    ...
    critic = build_critic_model(model_opt, opt, fields, None)
    ...
    trainer = build_trainer(
        opt, device_id, model, fields, optim, critic, model_saver=model_saver
    )
